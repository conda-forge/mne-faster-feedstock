...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mne-faster-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15375&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mne-faster-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mne-faster` can be installed with:

```
conda install mne-faster
```

It is possible to list all of the versions of `mne-faster` available on your platform with:
